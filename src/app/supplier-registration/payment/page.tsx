...
export default function SupplierPaymentPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      ...
      <section className="mx-auto max-w-md rounded-xl border bg-white p-6 shadow-sm space-y-6">
        ...
        {selectedPayment && (
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 rounded-lg border border-[#4F83A6] p-3">
        ...
        <div className="pt-4 flex justify-center">
          <Button className="rounded-full bg-[#5B86A8] px-10 hover:bg-[#4A748F]">
            Finalizar cadastro
          </Button>
        </div>
      </section>
